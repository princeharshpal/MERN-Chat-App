...
export function Sidebar() {
  ...
  return (
    <aside className="w-full md:w-[350px] border-r border-default-200 bg-background flex flex-col h-full overflow-hidden">
      {}
                    ...
                    >
                      <div className="flex items-center gap-2 min-w-0">
                        <img
                          src={
                            su.avatar?.url ||
                            `https://ui-avatars.com/api/?name=${encodeURIComponent(su.name || "U")}&background=7c3aed&color=fff&bold=true`
                          }
                          alt={su.name || "U"}
      ...
      {}
      <div className="p-4 bg-default-50/30">
        <div className="relative group">
        ...
        <div className="flex flex-col">
          {friends.length === 0 ? (
            <div className="p-8 text-center flex flex-col items-center justify-center opacity-70">
              <HiUserPlus className="text-4xl text-default-300 mb-2" />
              <p className="text-sm font-medium text-default-500">
                No friends yet
              </p>
              <p className="text-xs text-default-400 mt-1">
                Click the + icon to find people
              </p>
            </div>
          ) : (
            friends.map((friend) => (
              <button
                ...
                disabled={isOpeningChat === friend._id}
              >
                  ...
                  {isOpeningChat === friend._id ? (
                    ...
                    <div className="flex items-center gap-1.5 p-1 relative">
                      <img
                        src={
                          friend.avatar?.url ||
                          `https://ui-avatars.com/api/?name=${encodeURIComponent(friend.name || "U")}&background=7c3aed&color=fff&bold=true`
                        }
                        alt={friend.name || "U"}
